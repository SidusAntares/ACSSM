...
class AdaMoCo(nn.Module):
    ...
    def update_memory(self, epoch, idxs, keys_t, keys_f, keys_zqf, pseudo_labels, real_label):
        ...
        self.features[:, idxs_replace] = torch.flatten(keys_t, 1).T
    ...
    def forward(self, im, FE, Classifier,  mom_FE, mom_Classifier, im_k=None, im_kf=None,
                cls_only=False, ema_only=False):
